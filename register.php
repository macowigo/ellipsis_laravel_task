        ...
        <form method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="input-field col l6 m9 s12">
                    ...
                    <input id="firstname" name="fName" type="text" class="validate"
                    placeholder="Enter First Name" minlength="3" required>
                ...
                <div class="input-field col l6 m9 s12">
                    ...
                    placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*?]).{5,}" required>
